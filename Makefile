docker.build:
	...
	docker build --rm -t acidtib/ruby-ubuntu:3.2.2 -t acidtib/ruby-ubuntu:3.2 -t acidtib/ruby-ubuntu:3.2.2-jammy -t acidtib/ruby-ubuntu:3.2.2-22.04 3.2/jammy/
	docker build --rm -t acidtib/ruby-ubuntu:3.2.2-focal -t acidtib/ruby-ubuntu:3.2.2-20.04 3.2/focal/
